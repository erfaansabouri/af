!function () {
    ...
    !function () {
        ...
        var e = function (t) {
                ...
                for (var a, s, h, u, d, c = arguments.length, p = new Array(c), m = 0; m < c; m++) p[m] = arguments[m];
                ...
                for ("boolean" == typeof l && (v = l, l = p[y] || {}, y += 1), "object" !== n(l) && i(l) && (l = {}), y === f && (l = t, y -= 1); y < f; y++) if (a = p[y], !e(a) && null !== a) for (var g = 0; g < window.Object.keys(a).length; g++) {
                    ...
                    if (Object.prototype.hasOwnProperty.call(a, D)) {
                        ...
                        u = Array.isArray(h), v && h && (r(h) || u) ? (s = l[D], d = u && !Array.isArray(s) ? [] : u || r(s) ? s : {}, l[D] = o(v, d, h)) : e(h) || (l[D] = h)
                    }
                }
                return l
            }, h = function (t, n) {
                ...
                var n = arguments.length > 1 && void 0 !== arguments[1] ? arguments[1] : 2,
                    e = String(Math.abs(t)), i = e.length,
                    o = "";
                for (t < 0 && (o += "-"); i < n;) i += 1, o += "0";
                return o + e
            }, d = function (t, n, e) {
                var i = s(n, e), o = t.initDate,
                    a = t.options.maxDate,
                    r = t.options.minDate, h = i.year,
                    u = i.month, d = i.day;
                return isNaN(h) || h < 1e3 || h > 1999 ? h = o.year : h < r.year ? (h = r.year, u = 1) : h > a.year && (h = a.year), isNaN(u) || u < 1 || u > 12 ? u = o.month : h <= r.year && u < r.month ? (u = r.month, d = 1) : h >= a.year && u > a.month && (u = a.month), isNaN(d) || d < 1 ? d = o.day : u <= r.month && d < r.day ? d = r.day : u >= a.month && d > a.day && (d = a.day), {
                    year: parseInt(h),
                    month: parseInt(u),
                    day: parseInt(d)
                }
            }, c = function (t, n, e) {
                var i = s(n, e), o = t.initTime,
                    a = t.options.maxTime,
                    r = t.options.minTime, h = i.hour,
                    u = i.minute, d = i.second;
                return isNaN(h) || h < 0 || h > 23 ? h = o.hour : h < r.hour ? h = r.hour : h > a.hour && (h = a.hour), isNaN(u) || u < 0 || u > 59 ? u = o.minute : h <= r.hour && u < r.minute ? u = r.minute : h >= a.hour && u > a.minute && (u = a.minute), isNaN(d) || d < 0 || d > 59 ? d = o.second : h <= r.hour && u <= r.minute && d < r.second ? d = r.second : h >= a.hour && u >= a.minute && d > a.second && (d = a.second), {
                    hour: parseInt(h),
                    minute: parseInt(u),
                    second: parseInt(d)
                }
                ...
                var e = t.options.separatorChars;
                return "".concat(n.year).concat(e.date).concat(u(n.month)).concat(e.date).concat(u(n.day))
            }, y = function (t, n) {
                if (!n) return !1;
            ...
            H = "div.".concat(v, "-time"),
            Y = "not-in-range", L = "holly-day",
            k = "".concat(v, ":change"), z = "click",
            R = "focusin", J = "today", W = "attr",
            q = "data-jdp-only-date",
            F = "data-jdp-only-time",
            X = ("data-".concat(v), "visible"), G = "block",
            K = "none", Q = function t(n) {
                if (["html", "body", "#document"].indexOf((n.nodeName || "").toLowerCase()) >= 0) return window;
                if (n instanceof HTMLElement) {
                    var e = window.getComputedStyle(n),
                        i = e.overflow, o = e.overflowX,
                        a = e.overflowY;
                ...
                var s = t.split(".");
                t = s.shift() || "div";
                var h = s, u = window.document.createElement(t);
                return o(n) ? window.document.querySelector(n).appendChild(u) : n.appendChild(u), h.length && (u.className = h.join(" ")), i && a && function (t, n, e) {
                ...
                for (var e, i = [-61, 9, 38, 199, 426, 686, 756, 818, 1111, 1181, 1210, 1635, 2060, 2097, 2192, 2262, 2324, 2394, 2456, 3178], o = i.length, a = 0, r = -14, s = i[0], u = 1; u < o; u += 1) {
                    var d = i[u];
                    if (a = d - s, t < d) break;
                    r = r + 8 * n(a, 33) + n(h(a, 33), 4), s = d
                }
                var c = t - s;
                return a - c < 6 && (c = c - a + 33 * n(a + 4, 33)), -1 === (e = h(h(c + 1, 33) - 1, 4)) && (e = 4), 0 === e
            }, it = function (t, n, e) {
                var i = function (t, n) {
                    return t < 8 ? 31 * (t - 1) + n : 186 + 30 * (t - 7) + n
                };
                return h(function (t, n, e, o, a, r) {
                    for (var s = i(a, r) - i(n, e), h = t < o ? o : t, u = t < o ? t : o; u < h; u++) et(u) ? s += t < o ? 366 : -366 : s += t < o ? 365 : -365;
                    return s
                }(1392, 3, 25, t, n, e), 7)
            }, ot = function (t, n) {
        ...
        var at, rt, st = function (t, n) {
            ...
            for (var a, r, h = (a = s({
                ...
                minute: 0,
                second: 0
            }, t.options.minTime), r = s({
                hour: 23,
                minute: 59,
                second: 59
            }, t.options.maxTime), "hour" == e ? st(a.hour, r.hour) : "minute" == e ? a.hour == r.hour ? st(a.minute, r.minute) : t.initTime.hour == a.hour ? st(a.minute, 59) : t.initTime.hour == r.hour ? st(0, r.minute) : st(0, 59) : "second" == e ? a.hour == r.hour && a.minute == r.minute ? st(a.second, r.second) : t.initTime.hour == a.hour && t.initTime.minute == a.minute ? st(a.second, 59) : t.initTime.hour == r.hour && t.initTime.minute == r.minute ? st(0, r.second) : st(0, 59) : st(a.second, r.second)), u = 0; u < h.length; u++) {
                var d = $("option", o);
                d.value = h[u].toString(), d.text = nt(h[u], t.options.persianDigits), d.selected = parseInt(h[u]) === parseInt(t.getValue[e] || t.initTime[e])
            }
        }, ut = function (t) {
            return 6 === t ? ".".concat("last-week", ".").concat(L) : ""
        }, dt = function (t, n, e) {
            $(A + (e ? t.options.maxDate.year === t.initDate.year ? ".".concat(Y) : "" : t.options.maxDate.year === t.initDate.year && t.options.maxDate.month === t.initDate.month ? ".".concat(Y) : ""), n, z, e ? function () {
                t.increaseYear()
            } : function () {
                t.increaseMonth()
            }, t.options.plusHtml)
            ...
            pt(t), function (t) {
                ...
                for (var n = $(T, t.dpContainer), e = 0; e < 7; e++) $(E + ut(e), n, null, null, nt(t.options.days[e], t.options.persianDigits));
                ...
                }, a = o({}), r = ot(a.year, a.month), h = it(a.year, a.month, 1), u = 7 * Math.ceil((h + r) / 7) - 1, d = 1 == a.month ? 12 : a.month - 1, c = 12 == a.month ? 1 : a.month + 1, m = 12 == d ? a.year - 1 : a.year, l = 1 == c ? a.year + 1 : a.year, y = 1 == a.month ? ot(a.year - 1, d) : ot(a.year, d), f = it(a.year, a.month, a.day), v = y - f, g = 0, D = function (e) {
                    a.inBeforeMonth = a.day <= f && e < f, a.inAfterMonth = e >= r + f, (a.inBeforeMonth || a.inAfterMonth) && (a.inBeforeMonth ? (v++, a.day = v, a.year = m, a.month = d) : (g++, a.day = g, a.year = l, a.month = c)), a.isValid = p(t, a.year, a.month, a.day), a.className = ut(it(a.year, a.month, a.day)), t.inputValue.day === a.day && t.inputValue.year === a.year && t.inputValue.month === a.month && (a.className += ".".concat("selected")), t.today.day === a.day && t.today.year === a.year && t.today.month === a.month && (a.className += ".".concat("today")), i(t.options.dayRendering) && s(a, t.options.dayRendering(a, t.input)), a.isHollyDay && (a.className += ".".concat(L));
                    var h = a.isValid ? x : S;
                    (a.inBeforeMonth || a.inAfterMonth) && (h = I, a.isValid || (h = M));
                    var u = $(h + a.className, n, null, null, nt(a.day, t.options.persianDigits));
                    u.day = a.day, u.month = a.month, u.year = a.year, a.isValid && u.addEventListener(z, (function () {
                        t.setValue({
                            year: u.year,
                            month: u.month,
                            day: u.day
            ...
            tt(t.dpContainer, ""), t.options.date && mt(t), t.options.time && function (t) {
                var n = B + (t.options.time && !t.options.date ? ".jdp-only-time" : ""),
                    e = $(n, t.dpContainer);
                t.options.hasSecond && ht(t, e, "second"), ht(t, e, "minute"), ht(t, e, "hour")
            }(t), lt(t)
        };
        var ft = /iphone|ipod|android|ie|blackberry|fennec/.test(null === (at = window.navigator) || void 0 === at || null === (rt = at.userAgent) || void 0 === rt ? void 0 : rt.toLowerCase()),
            vt = {
                ...
                input: null,
                get dpContainer() {
                    return this._dpContainer && this._dpContainer.isConnected || (this._dpContainer = $(g, this.options.container), this.dpContainer.style.zIndex = this.options.zIndex), this.overlayElm && this.overlayElm.isConnected || (this.overlayElm = $(D, this.options.container), this.overlayElm.style.zIndex = this.options.zIndex - 1), this._dpContainer
                },
                get today() {
                ...
                setPosition: function () {
                    if (this.dpContainer.style.visibility === X) {
                        ...
                        e + a >= o && (e -= e + a - (o + this.options.overflowSpace)), i - n >= r && i + r >= window.innerHeight && (i -= r + n + this.options.bottomSpace + this.options.topSpace), this.dpContainer.style.position = "fixed", this.dpContainer.style.left = e + "px", this.dpContainer.style.top = i + "px"
                    }
                },
                get getValue() {
                ...
                setValue: function (t) {
                    ...
                    }, s(this._value, t)), this._initTime = null, this.input.value = (n = this, e = this._value, i = n.options.separatorChars, o = n.options.date ? "".concat(e.year).concat(i.date).concat(u(e.month)).concat(i.date).concat(u(e.day)) : "", a = n.options.time ? "".concat(u(e.hour)).concat(i.time).concat(u(e.minute)) + (n.options.hasSecond ? i.time + u(e.second) : "") : "", o + (o && a ? i.between : "") + a), Z(this.input, k), !this.options.time && this.options.hideAfterChange ? this.hide() : this._draw()
                },
