...
Route::middleware(['auth:admin'])->prefix('others')->group(function (){
    ...
    Route::get('/monthly-charges/{id}', [OtherController::class, 'monthlyCharges'])->name('admin.others.monthly-charges');
    Route::any('/fake-transaction', [OtherController::class, 'fakeTransaction'])->name('admin.others.fake-transaction');
