            ...
            <div class="topbar">
                <div class="topbar-item">
                    <div class="btn btn-icon btn-icon-mobile w-auto btn-clean d-flex align-items-center btn-lg px-2" id="kt_quick_user_toggle">
                        ...
                        <span class="text-dark-50 font-weight-bolder font-size-base d-none d-md-inline mr-3 iransans-web">| خوش آمدید {{ \Illuminate\Support\Facades\Auth::user()->full_name }}</span>
                ...
                <div class="dropdown">
                    ...
                    <div class="dropdown-menu p-0 m-0 dropdown-menu-anim-up dropdown-menu-sm dropdown-menu-right">
                        ...
                        <ul class="navi navi-hover py-4">
                            ...
                            <!--begin::Item-->
                            <li class="navi-item">
                                <a href="@if(Auth::guard('admin')->check()) {{ route('admin.auth.logout') }} @elseif(Auth::guard('tenant')->check()) {{ route('tenant.auth.logout') }}@elseif(Auth::guard('other')->check()){{ route('other.auth.logout') }} @endif" class="navi-link">
