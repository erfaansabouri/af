                                                ...
                                                @else
                                                    @if(!$record->paid_at)
                                                        <div class="btn-toolbar justify-content-between" role="toolbar" aria-label="Toolbar with button groups">
                                                            <a href="{{ route('other.transaction.choose-gateway', ['generate_url' => route('other.transaction.generate-url', ['other_monthly_charge_id' => $record->id])]) }}" class="btn btn-sm btn-success">پرداخت</a>
