                                ...
                                <table
                                    ...
                                    @foreach($records as $record)
                                        <tr>
                                            ...
                                            <td class="iransans-web">
                                                {{ number_format($record->original_amount) }} ریال
                                            </td>
                                            <td class="iransans-web">
                                                @if($record->paid_at)
                                                    <span class="label label-inline label-light-success">پرداخت موفق</span>
                                                ...
                                                @else
                                                    @if(!$record->paid_at)
                                                        <div class="btn-toolbar justify-content-between" role="toolbar" aria-label="Toolbar with button groups">
                                                            <a href="{{ route('other.transaction.choose-gateway', ['generate_url' => route('tenant.transaction.generate-url', ['other_monthly_charge_id' => $record->id])]) }}" class="btn btn-sm btn-success">پرداخت</a>
