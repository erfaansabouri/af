            ...
            <div class="container-fluid">
                <div class="card card-custom">
                    ...
                    <div class="card-body">
                        ...
                        <!--begin::Search Form-->
                        <div class="mb-7">
                            <form action="{{ route('other.transactions.index') }}" method="get">
                            ...
                            <table
                                ...
                                @foreach($records as $record)
                                    <tr>
                                        ...
                                        <td class="iransans-web">{{ $record->other->plaque }}</td>
                                        ...
                                        <td class="iransans-web">
                                            @if($record->paid_at)
                                                <a href="{{ route('other.transactions.pdf', $record->id) }}" class="btn btn-primary">PDF</a>
                                            @endif
                                        </td>
                                    </tr>
                                @endforeach
