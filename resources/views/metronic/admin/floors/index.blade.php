                    ...
                    <div class="card-body">
                        ...
                        <table
                            ...
                            <tr>
                                ...
                                <th class="iransans-web">شارژ پایه</th>
                            ...
                            @foreach($records as $record)
                                <tr>
                                    ...
                                    <td class="iransans-web">{{ $record->floor_fa }}</td>
                                    <td class="iransans-web">{{ is_numeric($record->base_charge_amount) ? number_format($record->base_charge_amount) : "ندارد" }}</td>
                                    <td>
                                        <div class="btn-toolbar justify-content-between" role="toolbar" aria-label="Toolbar with button groups">
                                            <div class="btn-group" role="group" aria-label="First group">
                                                <a href="{{ route('admin.floors.edit', $record->id) }}" class="btn btn-primary  btn-icon"><i class="la la-edit"></i></a>
                                            </div>
                                        </div>
                                    </td>
