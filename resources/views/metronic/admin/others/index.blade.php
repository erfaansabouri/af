                ...
                <div class="card card-custom">
                    <div class="card-header flex-wrap border-0 pt-6 pb-0">
                        ...
                        <div class="card-toolbar">
                            <!--begin::Button-->
                            <a href="{{ route('admin.others.create') }}"
                    ...
                    <div class="card-body">
                        ...
                        <table
                            ...
                            <tr>
                                ...
                                <th class="iransans-web">نوع</th>
                                <th class="iransans-web">کرایه ماهیانه</th>
                                <th class="iransans-web">بدهی</th>
                            ...
                            @foreach($records as $record)
                                <tr>
                                    ...
                                    <td class="iransans-web">
                                        {{ $record->plaque }}
                                        @if($record->tenant)
                                            واحد تجاری مربوطه: {{ $record->tenant->plaque }}
                                        @endif
                                    </td>
                                    <td>{{ $record->type }}</td>
                                    <td class="iransans-web">{{ is_numeric($record->monthly_charge_amount) ? number_format($record->monthly_charge_amount) . " ریال" : "ندارد" }}</td>
                                    <td class="iransans-web">{{ is_numeric($record->debt_amount) ? number_format($record->debt_amount) . " ریال" : "ندارد" }}</td>
                                    <td>
                                        <div class="btn-toolbar justify-content-between" role="toolbar" aria-label="Toolbar with button groups">
                                            <div class="btn-group" role="group" aria-label="First group">
                                                ...
                                                <a href="{{ route('admin.others.monthly-charges', $record->id) }}" class="btn btn-success btn-icon"><i class="la la-file-invoice"></i></a>
                                            </div>
                                        </div>
                                    </td>
